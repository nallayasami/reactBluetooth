...
export class BleHandler {
        ...
        this.manager.connectToDevice(id, {autoConnect: true})
            ...
            .then(services => {
                ...
                services.forEach(service => {
                    ...
                    this.invokeService(service, callback);
                    // }
                })
            })
            // device.connect()
    ...
    invokeService(service, callback) {
                ...
                c.forEach(char => {
                    ...
                    char.monitor((error, characteristic) => {
                        if (!error) {
                            ...
                            callback(this.base16(decode(characteristic?.value)) +'-'+ decode(characteristic?.value))
                        } else {
